...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an the toolset-native PRD-to-SRS lane instead of vague planning prose.
---
...
If useful, point to the next the toolset-native lane:
...
HANDOFF
- what should happen next and which the toolset lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and the toolset 2.0 planning surfaces.
