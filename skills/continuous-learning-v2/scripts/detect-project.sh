...
_SKILLFORGE_HOMUNCULUS_DIR="$(_sf_resolve_homunculus_dir)"
_CLV2_PROJECTS_DIR="${_SKILLFORGE_HOMUNCULUS_DIR}/projects"
_CLV2_REGISTRY_FILE="${_SKILLFORGE_HOMUNCULUS_DIR}/projects.json"
...
_clv2_detect_project() {
  ...
  if [ -z "$project_root" ]; then
    ...
    _CLV2_PROJECT_ROOT=""
    _CLV2_PROJECT_DIR="${_SKILLFORGE_HOMUNCULUS_DIR}"
    return 0
  fi
