...
Analyze a draft prompt, critique it, match it to the toolset ecosystem components,
...
- User says "how should I use the toolset for..."
...
- User is asking about configuration (use `configure-toolset` instead)
...
### Phase 3: the toolset Component Matching
...
### Section 2: Recommended the toolset Components
...
A compact version for experienced the toolset users. Vary by intent type:
...
- "Optimize this prompt for the toolset"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt the toolset for this task?"
...
|-----------|------------------|
| `configure-toolset` | User hasn't set up the toolset yet |
