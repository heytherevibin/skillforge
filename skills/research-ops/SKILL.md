---
name: research-ops
description: Evidence-first current-state research workflow for the toolset. Use when the user wants fresh facts, comparisons, enrichment, or a recommendation built from current public evidence and any supplied local context.
---
